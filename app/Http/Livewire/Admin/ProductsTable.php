...
final class ProductsTable extends PowerGridComponent
{
    ...
    public string $primaryKey = 'products.id_product';
    public string $sortField = 'products.id_product';
    ...
    */
    ...
    {
        return Product::query()->whereNull('deleted_at')->with('discount', 'category')->orderBy('updated_at', 'DESC');
    }
