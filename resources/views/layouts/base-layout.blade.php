...
<body>
    ...
    <main class="pt-24 relative">
        ...
        <div class="hidden lg:block fixed right-0 bottom-20 z-20 cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-14 h-14 mx-6 my-2 " fill="green"
                id="whatsapp">
                <path
            ...
            <p class="text-white font-bold bg-green px-6 py-2 rounded-l-full ">
                Shop Or Ask </br>Via WhatsApp</p>
        </div>

        {{-- mobile --}}
        <div class="lg:hidden animate-ping rounded-full w-10 h-10 bg-green p-2 z-20 cursor-pointer fixed right-6 bottom-6"></div>
