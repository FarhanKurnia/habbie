                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                ...
                                @if ($page == $paginator->currentPage())
                                    <span
                                        class="px-2 py-1 m-1 text-center border-pink-primary rounded cursor-pointer border-1 dark:bg-pg-primary-700 dark:text-white dark:text-pg-primary-300"
                                    >{{ $page }}</span>
                                @elseif (
                                    $page === $paginator->currentPage() + 1 ||
                                        ...
                                        $page === $paginator->currentPage() - 2)
                                    <a
                                        class="px-2 py-1 m-1 text-center text-pink-primary  rounded cursor-pointer border-1"
