        ...
        <div class="lg:w-3/4 mx-auto pb-10">
            ...
            @if (count($cartItems) === 0)
                <div class="text-center bg-grey-secondary-50 rounded-md p-10">
                    <img class="h-40 mx-auto p-6 opacity-30" src="{{ url('storage/img/empty-cart.png') }}" alt="empty cart">
                    ...
                    <a href="{{ url('products') }}" class="flex justify-center py-2">
                        <button class="btn btn-sm btn-primary rounded-full font-bold text-white text-md ">Shop Now!</button>
                    </a>
                </div>
            @else
