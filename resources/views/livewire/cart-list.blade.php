<div class="container mx-auto">
    ...
    <div class="lg:w-3/4 mx-auto pb-10">
        ...
        <div class="overflow-x-auto">
            <table class="table">
                <thead class="bg-grey-secondary-50">
                ...
                <tbody>
                    @foreach ($cartItems as $item)
                        <tr class="text-left">
                            <td>
                                <span class="p-2 hover:text-pink-primary cursor-pointer"
                            ...
                            <td>{{ \App\Helpers\CurrencyFormat::data($item['price']) }}</td>
                            <td class="items-center">
                                <livewire:cart-update :item="$item" :key="$item['id']" />
                            </td>
                            <td>{{ \App\Helpers\CurrencyFormat::data($item['price'] * $item['quantity']) }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
